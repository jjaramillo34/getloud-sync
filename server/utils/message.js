...
export const messageUtils = {
  ...
  generatePlayerStateChangeMessage: (userName, videoPlayerState) => {
    const formattedTimeInVideo = generalUtils.toHHMMSS(
      videoPlayerState.timeInVideo
    );
    ...
    switch (videoPlayerState.playerState) {
      ...
      case "playing":
        ...
        break;
      case "skipped":
        playerStateChangeMessage = `${userName} skipped the video to ${formattedTimeInVideo}`;
        break;
      default:
        break;
    }
